...
class MySQLTicketService:
    """
    Service for retrieving data from MySQL `DB_TICKETS` table.
    ...
    def fetch_tickets_by_status(
        ...
        query = "SELECT * FROM DB_TICKETS WHERE status = %s ORDER BY id DESC LIMIT %s OFFSET %s"
